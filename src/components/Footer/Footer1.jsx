...
{/* bg-gray-400  cursor-pointer hover:scale-[2] hover:text-pink-500 hover:bg-black hover:transition-all duration-1000 delay-200 text-white p-1.5 text-3xl rounded-2xl */}
                           <CiTwitter className=" icn " />
                            <FaLinkedin className= " icn"/>
                            <FaInstagram className="icn "/>
                            <FaYoutube className="icn "/>
                          </div>
            </div> 
            ...
            <div className="mt-2">
              <h1 className="font-bold mb-4 opacity-70">Get App</h1>
               <div className="flex items-center cursor-pointer bg-black text-white rounded-md mb-2">
              ...
              <div className="flex cursor-pointer bg-black items-center text-white rounded-md ">
